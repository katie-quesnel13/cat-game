...
spotted_names = ["Spotted", "Pebble", "Dapple", "Nut", "Brook", "Plum", "Leopard", "Lily"]
classic_names = ["Pool", "River", "Stream", "Wave", "Brook", "Splash", "Twist", "Chive"]
tortie_names = ["Dapple", "Bloom", "Petal", "Bird", "Tree", "Light", "Moss", "Maple", "Nectar"]
white_names = ["Snow", "Moon", "Light", "White", "Frost", "Ice", "Pale", "Hail", "Cloud", "Dove", "Down",
               "Freeze", "Bright", "Clover", "Dew", "Shine"]
pointed_names = ["Pale", "Dawn", "Light", "Bug", "Sand", "Daisy", "Sky", "Berry"]
